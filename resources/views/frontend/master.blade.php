...
<head>
	...
	<!-- Favicon -->   
	<link href="{{asset('/front_assets')}}/img/favicon.ico" rel="shortcut icon"/>
			...
			<div class="row">
				<div class="col-lg-3 col-md-8 col-sm-12">
					<div class="footer-widget about-widget">
						<img src="{{asset('front_assets')}}/img/logo.png" class="footer-logo" alt="">
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
	...
	<script src="{{asset('/front_assets')}}/js/sly.min.js"></script>
